...
import { OMNIDEF } from './sPCMEditReferralEnglish_def.js';
import tmpl from './sPCMEditReferralEnglish.html';
import tmpl_nds from './sPCMEditReferralEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPCMEditReferralEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
