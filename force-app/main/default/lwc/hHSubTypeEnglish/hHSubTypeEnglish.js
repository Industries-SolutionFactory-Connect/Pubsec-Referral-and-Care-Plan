...
import { OMNIDEF } from './hHSubTypeEnglish_def.js';
import tmpl from './hHSubTypeEnglish.html';
import tmpl_nds from './hHSubTypeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class hHSubTypeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
