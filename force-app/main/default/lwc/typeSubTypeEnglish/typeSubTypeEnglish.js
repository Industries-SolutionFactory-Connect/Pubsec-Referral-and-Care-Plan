...
import { OMNIDEF } from './typeSubTypeEnglish_def.js';
import tmpl from './typeSubTypeEnglish.html';
import tmpl_nds from './typeSubTypeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class typeSubTypeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
