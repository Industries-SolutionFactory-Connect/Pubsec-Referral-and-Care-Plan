...
import { OMNIDEF } from './type1SubType1English_def.js';
import tmpl from './type1SubType1English.html';
import tmpl_nds from './type1SubType1English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class type1SubType1English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
