import { FlexCardMixin } from "omnistudio/flexCardMixin";
 ...
 this.registerEvents();
        ...
        this.pubsubEvent[0] = {
          [interpolateWithRegex(`pc_participants_selection_changed`,this._allMergeFields,this._regexPattern,"noparse")]: this.handleEventAction.bind(this, data.events[0],0)
        };
        this.pubsubChannel0 = interpolateWithRegex(`rowSelection`,this._allMergeFields,this._regexPattern,"noparse");
