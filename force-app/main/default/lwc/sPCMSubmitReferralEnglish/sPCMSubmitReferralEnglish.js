...
import { OMNIDEF } from './sPCMSubmitReferralEnglish_def.js';
import tmpl from './sPCMSubmitReferralEnglish.html';
import tmpl_nds from './sPCMSubmitReferralEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sPCMSubmitReferralEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
